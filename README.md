...
jobs:
  logLatestRelease:
    ...
    steps:
      - uses: step-security/octokit-request-action@v3
...
`step-security/octokit-request-action` is using [`@octokit/request`](https://github.com/octokit/request.js/) internally with the addition
